                ...
                Task.Factory.StartNew(() =>
                                      {
                                          ...
                                          switch (command)
                                          {
                                              ...
                                              case "createlobby":
                                              {
                                                  ...
                                                  if (
                                                      !clients.Any(
                                                          m =>
                                                              m.Mods.Any(
                                                                  c => c.name == mod.name && c.version == mod.version)))
                                                  {
                                                      var obj = new JObject();
                                                      obj["msg"] = "modneeded";
                                                      obj["name"] = mod.name;
                                              ...
                                              case "joinlobby":
                                              {
                                                  ...
                                                  //Find lobby
                                                  var lob =
                                                      LobbyManager.PublicLobbies.FirstOrDefault(m => m.id == req.LobbyID);
                                                  if (lob == null)
                                                  {
                                              ...
                                              case "installmod":
                                              {
                                                  ...
                                                  if (
                                                      clientControllers.FirstOrDefault()
                                                          .Mods.Any(m => m.name == mod.name && m.version == mod.version))
                                                  {
                                                      this.AsyncSendTo(x => x.user != null && x.user.Id == user.Id,
                                                          InstallResponse("The mod has already been installed.", true),
                                                          rf => { });
                                                      return;
                                                  }
